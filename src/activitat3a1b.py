...
start = clock()
print ("Activitat: 3-SVM amb kernel lineal amb C vble (PAC2 / Activitat 2)")
print ("")
...
for exp in range(-4,5,1):
    resultats_prova=[]
    model = 'data/activitat3a1b.'+str(10**exp)+'.model.txt'
    preds = 'data/activitat3a1b.'+str(10**exp)+'.predicciones.txt'
    outs  = 'data/activitat3a1b.'+str(10**exp)+'.output.txt'
