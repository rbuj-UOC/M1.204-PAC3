...
start = clock()
print ("Activitat: 3-SVM amb kernel polinomic amb diferents graus i C (PAC2 / Activitat 1)")
print ("")
...
for exp in range(-4,5,1):
    for grau in range(0,5,1):
        resultats_prova=[]
        model = 'data/activitat3b1a.'+str(grau)+'.'+str(10**exp)+'.model.txt'
        preds = 'data/activitat3b1a.'+str(grau)+'.'+str(10**exp)+'.predicciones.txt'
        outs  = 'data/activitat3b1a.'+str(grau)+'.'+str(10**exp)+'.output.txt'
