...
for exp in range(-4,5,1):
    for gamma in range(-4,5,1):
        resultats_prova=[]
        model = 'data/activitat3c1b.'+str(10**exp)+'.'+str(10**exp)+'.model.txt'
        preds = 'data/activitat3c1b.'+str(10**exp)+'.'+str(10**exp)+'.predicciones.txt'
        outs  = 'data/activitat3c1b.'+str(10**exp)+'.'+str(10**exp)+'.output.txt'
